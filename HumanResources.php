...
?>
    ...
    <title>Add Issues</title>
            ...
            <div class="row">
                ...
                <div class="col-75">
                  <input type="text" name="department_issue" value="Human Resources" readonly>
                </div>
              </div>
            ...
            $sql = mysqli_query($link, "SELECT emp_id, emp_name FROM employee WHERE emp_department = 'Human Resources'");
