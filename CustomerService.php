...
<h2>Submit an Issue</h2>
            ...
            <div class="row">
                ...
                <div class="col-75">
                  <input type="text" name="department_issue" value="Customer Service" readonly>
                </div>
              </div>
            ...
            $sql = mysqli_query($link, "SELECT emp_id, emp_name FROM employee WHERE emp_department = 'Customer Service'");
